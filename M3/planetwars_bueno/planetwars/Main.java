					...
					if (sc.hasNextInt()) {
						...
						if (inRange) {
							...
							case 1:
								...
								System.out.println("Tecnologia defensa actualizada\n");
								break;
							case 2:
								planet.upgradeTechnologyAttack();
								System.out.println("Tecnologia ataque actualizada\n");
								break;
							case 3:
								salir = true;
								break;
